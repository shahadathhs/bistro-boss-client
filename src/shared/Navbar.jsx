      ...
      <div className="navbar-end">
        ...
        <div>
          { 
            user
            ?
            <div className="dropdown dropdown-hover dropdown-end mx-2 pt-2">
              {/* hover element */}
                ...
                <div className="w-8 rounded">
                  {
                    ...
                    :
                    <div className="flex justify-center text-2xl my-auto pt-1 text-orange-500">No image</div>
                  }
                </div>
              </div>
              {/* dropdown */}
              <ul tabIndex={0} className="dropdown-content z-50 menu p-2 shadow bg-base-100 space-y-2 rounded-box">
                {/* profile */}
                <div className="flex flex-col justify-center max-w-[220px] shadow-md rounded-xl p-6 text-black">
                  {
                    user.photoURL 
                    ?
                  ...
                  <div className="space-y-4 text-center divide-y dark:divide-gray-700">
                    ...
                    {/* email */}
                    <div className="my-2 space-y-1 overflow-auto p-2">
                      <h2 className="text-sm font-semibold">{user.email || "email not found"}</h2>
                    </div>
                    {/* social icons */}
                    <div className="flex justify-center gap-2 pt-4">
                      <a rel="noopener noreferrer" href="#" aria-label="GitHub" className="rounded-md dark:text-gray-100 hover:dark:text-indigo-400">
                      ...
                      <a rel="noopener noreferrer" href="#" aria-label="Dribble" className="rounded-md dark:text-gray-100 hover:dark:text-indigo-400">
                      ...
                      <a rel="noopener noreferrer" href="#" aria-label="Twitter" className="rounded-md dark:text-gray-100 hover:dark:text-indigo-400">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                    ...
                    {/* logout */}
                    <div className="pt-2">
                      <button onClick={handleLogout}  className="btn btn-outline shadow-xl">Logout</button>
                    </div>
                  </div>
                </div>
              </ul>
